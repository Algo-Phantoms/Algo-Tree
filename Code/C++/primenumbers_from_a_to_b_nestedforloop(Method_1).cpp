...
int main()
{
    ...
    Check_Prime(a,b); // Called the function Check_Prime and passed the argument a & b

    return 0;
}

/* 
    Sample cases : You can give value of a,b as input till 18,446,744,073,709,551,615
/*
