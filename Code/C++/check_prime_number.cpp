...
/*Time Complexity: O(sqrt(n)),  n is the number.
  Space Complexity : O(1), no extra space is used here.
*/

/* Test Case :
35 -> 35 is divisible by 5 ( which is less than sqrt(35)) so it is not a prime number;
17 -> 17 is only divisible by 1 and 17 itself. So, it is a prime number
*/


/* Approach when we need to check for more than one numbers, in a single testcase then this approach will have less time complexity. */
