...
if(pangram(string)==True):
    ...
    '''Test cases: 
1) I/P:The Quick Brown Fox Jumps Over The Lazy Dog
   O/P:The given string is a pangram

2) I/P:2brown5! (including special characters and digits)
   O/P:The given string is not a pangram
'''
