...
2nd line contains the element they want to insert, delete, ect according to the choice they make (except in the case of third choice, where the 2nd line is to enter the position and the 3rd line is to enter the element).
