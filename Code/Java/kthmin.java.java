...
After Sorting then for kth Min Elemets, when sorting is descending
so for kth min element return (arr.legth -k)th Element
*/
...
public class KthMin {
    public static void main(String[] args) {
        ...
        int n = scan.nextInt();
        // Enter value of k for with kth Min Element is to be found
        int k = scan.nextInt();
        int[] arrr = new int[n];
        for (int i = 0;i<n;i++){
            arrr[i] = scan.nextInt();
    ...
    // Method for getting value of kth Min element
