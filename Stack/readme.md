...
-   Balanced Bracket Problem ----> [C++](/Code/C++/balanced_bracket.cpp) /[Java]
-   Stock Span Problem ----> [C++](/Code/C++/Stock_Span_Problem.cpp) | [Python](/Code/Python/StockSpan.py) | [Java] (Stock Span Problem .Java)
